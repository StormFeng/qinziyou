...
public class MapViewFactory {
	...
	public View createView(int position, int size, Bitmap mBitmap) {
		...
		TextView ioc_img = (TextView) main_layout.findViewById(R.id.ioc_img);

		if (size > 1) {
            title.setVisibility(View.VISIBLE);
            ioc_img.setVisibility(View.VISIBLE);
		} else {
            title.setVisibility(View.GONE);
            ioc_img.setVisibility(View.GONE);
		}
...
//		ioc_img.setImageBitmap(mBitmap);
	...
	public View createDefaultView(int position, int size) {
        ...
        TextView title = (TextView) defaultView.findViewById(R.id.title);
		TextView ioc_img = (TextView) defaultView.findViewById(R.id.ioc_img);
