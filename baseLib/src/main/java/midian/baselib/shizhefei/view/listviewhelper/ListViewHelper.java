...
public class ListViewHelper<DATA> implements OnRefreshListener<ListView> {
	...
	public  ILoadViewFactory loadViewFactory = new DeFaultLoadViewFactory();


	public ListViewHelper(PullToRefreshListView pullToRefreshAdapterViewBase) {
		super();
		init(pullToRefreshAdapterViewBase, loadViewFactory.madeLoadView(),
	...
	public void init(PullToRefreshListView pullToRefreshAdapterViewBase,
					 ILoadView loadView, ILoadMoreView loadMoreView){
	 ...
	 * @param fractory
	 */
	public  void setLoadViewFractory(ILoadViewFactory fractory) {
