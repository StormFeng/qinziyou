 ...
 */
public class Scroll1 extends ScrollView {
    ...
    public Scroll1(Context context) {
        super(context);
        init();
    }

    public Scroll1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public Scroll1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
